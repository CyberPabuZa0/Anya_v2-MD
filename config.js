...
module.exports = {
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://pabasara:pabasara@123@cluster0.lew2o.mongodb.net/",
    sessionId: process.env.SESSION_ID || "w1OQEVT_A_N_Y_A_V_2_2REtWPffl19nH",
